...
class JsonRpcClient {
    ...
    _canBeCached(blockNumber) {
        ...
        return !this._canBeReorgedOut(1);
    }
  ...
  async _perform(method, params, tType, getMaxAffectedBlockNumber) {
    ...
    if (method.startsWith("eth_getBlock") && rawResult && rawResult.gasLimit === undefined) {
        rawResult.gasLimit = "0x0";
       
    }
    if (method.startsWith("eth_getBlock") && rawResult && rawResult.difficulty === undefined) {
        rawResult.difficulty = "0x0";
       
    }
    if (method.startsWith("eth_getBlock") && rawResult && rawResult.totalDifficulty === undefined) {
        rawResult.totalDifficulty = "0x0";
       
    }

    if (method.startsWith("eth_getBlock") && rawResult && rawResult.uncles === undefined) {
        rawResult.uncles = [];  
    }
    if (method.startsWith("eth_getBlock") && rawResult && rawResult.sha3Uncles === undefined) {
        rawResult.sha3Uncles = '0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347'
    }
